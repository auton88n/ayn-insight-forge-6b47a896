...
var AYNQuestionEngine = (() => {
  ...
  __export(question_engine_exports, {
    ...
    applyAdapterConfig: () => applyAdapterConfig,
  ...
  function withAnswer(q, answer, source) {
  ...
  function withVerification(q, result) {
    return freezeQuestion({
      ...q,
      verified: result,
  ...
  function appendHistory(q, note) {
    const entry = { stage: note, at: Date.now() };
  ...
  function applyAdapterConfig(remote, version) {
    try {
  ...
  function projectFromLegacyAnswer(descriptorAnswer) {
  ...
  return __toCommonJS(question_engine_exports);
})();
window.AYNQuestionEngine = AYNQuestionEngine;
