  ...
  return (
    <div className="space-y-4 max-w-3xl">
      ...
      <Section title="Pre-Screening Questions" subtitle="Questions Canadian employers legally ask at the application stage" defaultOpen={false}>
        <RadioGroup
          label="Have you ever been convicted of a criminal offence for which a pardon has not been granted?"
          tip="Under the Ontario Human Rights Code and most provincial codes, employers may only ask about unpardoned convictions."
          options={[
            { value: "no", label: "No" },
            { value: "yes", label: "Yes" },
