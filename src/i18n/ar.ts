...
export const ar: Record<string, string> = {
  ...
  'auth.registrationSuccess': 'تحقق من بريدك الإلكتروني',
  'auth.registrationSuccessDesc': 'إذا كان هذا العنوان جديدًا، فقد أرسلنا رابطًا لتأكيد حسابك. هل لديك حساب بالفعل؟ سجّل الدخول، أو استخدم نسيت كلمة المرور.',
